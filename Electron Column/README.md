...
Kits commonly have 1 MOhm, 2MOhm, 4.7MOhm and 5.6MOhm values of resistors as well as some other common values, which are all the building blocks we'll use. You can make a 2.8 MOhm resistor using a 2MOhm, 470kOhm and 330kOhm in series. Make a 2.1 MOhm resistor using a 2MOhm and 100kOhm resistor. Use one 100kOhm resistor. Make a 5 MOhm resistor using 2 2MOhm resistors and 1 1MOhm resistor. Wire them up like this to make a voltage divider -10kV -> 2.8MOhm ->  2.1MOhm -> 0.1MOhm -> 5MOhm -> 0V

This makes a voltage divider circuit like so: 

![circuit (7)](https://github.com/user-attachments/assets/608f6e54-87d3-4c61-94e8-539a702a5782)
